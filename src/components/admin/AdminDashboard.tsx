          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 dark:hover:bg-slate-800 px-3 py-1.5 rounded-lg transition-colors border border-slate-200 dark:border-slate-700 cursor-pointer"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-sm text-slate-900 dark:text-white">MonitorBot 后台管理</span>
                <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-cyan-50 dark:bg-cyan-950 text-cyan-700 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-800">
                  DevOps
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {onOpenDownload && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs bg-cyan-50 hover:bg-cyan-100 dark:bg-cyan-950/80 dark:hover:bg-cyan-900/80 text-cyan-700 dark:text-cyan-300 px-3 py-1.5 rounded-lg border border-cyan-200 dark:border-cyan-800 transition-colors cursor-pointer"
                  title="打包下载项目全部文件与信息"
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs bg-slate-100 hover:bg-slate-200 dark:bg-cyan-500/20 dark:hover:bg-cyan-500/30 text-slate-700 dark:text-cyan-300 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-cyan-500/40 transition-colors cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1 space-y-1">
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-xs font-medium text-left transition-all cursor-pointer ${
                activeTab === 'overview'
                  ? 'bg-cyan-50 dark:bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-500/30 font-semibold shadow-xs'
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      onClick={() => setActiveTab('telegram')}
                      className="px-3 py-1.5 rounded-lg bg-white hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-xs text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
                    >
                      配置 Telegram Bot 凭据
                    </button>
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-cyan-50 hover:bg-cyan-100 dark:bg-cyan-600/20 dark:hover:bg-cyan-600/30 text-cyan-700 dark:text-cyan-300 text-xs border border-cyan-200 dark:border-cyan-500/40 transition-colors cursor-pointer"
                    >
                      + 添加受控服务器节点
                    </button>
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-600/20 dark:hover:bg-emerald-600/30 text-emerald-700 dark:text-emerald-300 text-xs border border-emerald-200 dark:border-emerald-500/40 transition-colors cursor-pointer"
                    >
                      + 添加新 HTTP/TCP 探测
                    </button>
                    <button
                      onClick={() => setActiveTab('deployment')}
                      className="px-3 py-1.5 rounded-lg bg-orange-50 hover:bg-orange-100 dark:bg-orange-600/20 dark:hover:bg-orange-600/30 text-orange-700 dark:text-orange-300 text-xs border border-orange-200 dark:border-orange-500/40 transition-colors cursor-pointer"
                    >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium border border-slate-200 dark:border-slate-700 transition-colors disabled:opacity-50 cursor-pointer"
                      >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        type="submit"
                        className="px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 dark:bg-cyan-500 dark:hover:bg-cyan-400 text-white dark:text-slate-950 font-bold text-xs transition-colors shadow-xs cursor-pointer"
                      >
                        保存配置
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {customApiUrl && (
                        <button
                          ...
                          className="px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs transition-colors shrink-0 cursor-pointer"
                        >
                          恢复默认边缘模式
                        </button>
                      )}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-cyan-600 hover:bg-cyan-500 dark:bg-cyan-500 dark:hover:bg-cyan-400 text-white dark:text-slate-950 font-bold text-xs transition-colors cursor-pointer"
                  >
                        ...
                        <tr key={node.id} className="hover:bg-slate-50 dark:hover:bg-slate-900/40">
                          ...
                          <td className="py-2.5 px-3 text-right space-x-2">
                            <button
                              ...
                              className="text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 cursor-pointer p-1"
                              title="编辑"
                            >
                            ...
                            <button
                              ...
                              className="text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 cursor-pointer p-1"
                              title="删除"
                            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 dark:bg-emerald-500 dark:hover:bg-emerald-400 text-white dark:text-slate-950 font-bold text-xs transition-colors cursor-pointer"
                  >
                    <Plus className="w-3.5 h-3.5" />
                    <span>添加端点</span>
                  </button>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 dark:bg-amber-500 dark:hover:bg-amber-400 text-white dark:text-slate-950 font-bold text-xs transition-colors cursor-pointer"
                  >
                    <Plus className="w-3.5 h-3.5" />
                    <span>发布新事件</span>
                  </button>
                    ...
                    <div key={inc.id} className="p-4 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex items-start justify-between gap-4 shadow-2xs">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-1.5 rounded text-cyan-600 dark:text-cyan-400 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
                          title="编辑"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 rounded text-rose-600 dark:text-rose-400 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
                          title="删除"
                        >
              ...
              <div className="space-y-6">
                ...
                <div className="p-5 rounded-xl bg-gradient-to-r from-cyan-50/70 via-white to-slate-50 dark:from-cyan-950/40 dark:via-slate-900 dark:to-slate-950 border border-cyan-200 dark:border-cyan-500/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="shrink-0 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-semibold shadow-lg shadow-cyan-950/20 dark:shadow-cyan-950/50 transition-all cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-3 flex flex-col justify-between shadow-2xs">
                    ...
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium border border-slate-200 dark:border-slate-700 transition-colors"
                    >
                  ...
                  <div className="p-4 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-3 flex flex-col justify-between shadow-2xs">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
                    >
                      <Download className="w-3.5 h-3.5 text-cyan-600 dark:text-cyan-400" />
                  ...
                  <div className="p-4 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-3 flex flex-col justify-between shadow-2xs">
                    ...
                    <label className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-medium border border-slate-200 dark:border-slate-700 cursor-pointer transition-colors">
